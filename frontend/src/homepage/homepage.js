              ...
              return (
                <Row style={{ margin: "48px" }}>
                  ...
                  <Col key={index} style={{ flexGrow: 1 }}>
                    <Link to='./serve' className="card" style={{ width: "100%", fontSize: "10px" }} >
                      <div className="card-header ">
                        <img src={`data:image/jpeg;base64,${post.image}`} alt={`${index + 1}`} style={{ height: 200, width: "200px", display: 'block' }}></img>
                      </div>
