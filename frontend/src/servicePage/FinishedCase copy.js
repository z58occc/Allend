  ...
  return (
    <div className="d-flex flex-wrap justify-content-around">
      {data.map((caseData, index) => (
        <Card key={index} id={index}  className="my-3" style={{ width: '720px', height: '150px', display: 'flex' }} onClick={()=> handleModalShow(index)}>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          <div className="container" style={{ fontSize: '18px' }}>
            ...
            <div>
              <div className="col" style={{ marginBottom: '10px', fontSize: '20px' }}>
                <strong>接案人姓名</strong> {data[selectedDataKey].contractorName}
              </div>
              <div className="col" style={{ marginBottom: '10px', fontSize: '20px' }}>
                <strong>接案人Email:</strong> {data[selectedDataKey].contractorEmail}
              </div> 
              <div className="col" style={{ marginBottom: '10px', fontSize: '20px' }}>
                <strong>接案人手機:</strong> {data[selectedDataKey].contractorPhone}
              </div>
              <div className="col" style={{ marginBottom: '10px', fontSize: '20px' }}>
                <label >輸入評價:</label>
