...
import ResetPassword from './MemberTool/ResetPassword';
...
function App() {
  ...
  const [isLogout, setIsLogout] = useState(false); //登出模塊
  ...
  const fetchMemberEmail = async () => {
    try {
      const response = await axios.get(
        'http://localhost/Allend/backend/public/api/user/email',
        {
          headers: {
  ...
  return (
    ...
    >
      ...
      {isLoggedIn ? (
        showChat ? (
          <PublicMessagesPage receiverId={selectedItemMid} />
        ) : (
          <Closechat />
        )
      ) : (
      ...
      <Routes>
        ...
        <Route
          path='/findcase/:type?/:casesearch?'
          element={<Findcase />}
        ></Route>
        <Route
          path='/findman/:s_type?/:servicesearch?'
          element={<Findman />}
        ></Route>
        ...
        <Route path='/collect' element={<CollectionsMain />}></Route>
            ...
            <div className='col-12'>
              <div className='row '>
                <div className='col-sm-12 '>
                  ...
                  <InputGroup>
                    <InputGroup.Text controlId='formBasicEmail'>
                      <FaUser />
                    </InputGroup.Text>
                    <Form.Control
                      type='email'
                ...
                <div className='col-sm-12' style={{ marginTop: '15px' }}>
                  ...
                  <InputGroup>
                    <InputGroup.Text controlId='formBasicPassword'>
                      <RiLockPasswordFill />
                    </InputGroup.Text>
                    <Form.Control
                      type='password'
      ...
      >
        ...
        <Modal.Body>
          <Form>
            ...
            <InputGroup>
              <InputGroup.Text controlId='formForgotPasswordEmail'>
      ...
      >
        <Modal.Header closeButton style={{ borderBottom: '1px solid black' }}>
          <Modal.Title className='col text-center'>
            <FaUserPlus />
            會員註冊
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Label style={{ fontSize: '20px', marginTop: '10px' }}>
              帳號{' '}
              {errorRegister && (
                <span style={{ color: 'red', paddingLeft: '20px' }}>
                  {errorRegister}
            ...
            <InputGroup>
              <InputGroup.Text controlId='formBasicConfirmedPassword'>
                <FaLock />
              </InputGroup.Text>
              <Form.Control
                type='password'
          ...
          <div>
            ...
            >
              {countdown > 0 ? (
                ...
                <Button variant='success' onClick={handleResendVerification}>
                  重新發送驗證郵件
                </Button>
              )}
            </div>
      ...
      <LogoutInformModal isLogout={isLogout} setIsLogout={setIsLogout} />
    </IsLoggedInContext.Provider>
  );
}
