...
const Findman = () => {
  // 接context
  const { isLoggedIn, handleShow, showChat, setShowChat, setSelectedItemMid } =
  ...
  useEffect(() => {
    const fetchService = async () => {
      try {
        ...
        const baseURL =
          'http://localhost/Allend/backend/public/api/printservicecardcontent';
  ...
  const addServiceCollection = (sid) => {
    axios({
      ...
      .then((res) => {
        const newData = service.map((item) =>
          item.sid === sid ? { ...item, fid: res.data.fid.fid } : item
        );
        setService(newData);
      })
      .catch((err) => {
  ...
  const cancelServiceCollection = (fid) => {
    axios({
      ...
      .then((res) => {
        const newData = service.map((item) =>
          item.fid === fid ? { ...item, fid: null } : item
        );
        setService(newData);
      })
      .catch((err) => {
          ...
          <div className='col-sm-2' style={{ marginTop: '45px' }}>
            ...
            <div className={`${styles.selectContainer}`}>
              ...
              <div className={`${styles.checkboxContainer}`}>
                ...
                ></input>
                <label className='ms-2' htmlFor='personalCheckbox'>
                  個人
                </label>
                <br></br>
                <input
                  ...
                  onChange={handleidentityChange}
                ></input>
                <label className='ms-2' htmlFor='companyCheckbox'>
                  公司
                </label>
                <br></br>
                <input
                  ...
                  onChange={handleidentityChange}
                ></input>
                <label className='ms-2' htmlFor='studioCheckbox'>
                  工作室
                </label>
              </div>
            </div>
            ...
            <div className={`${styles.selectContainer}`}>
              ...
              <div className={`${styles.checkboxContainer}`}>
                ...
                ></input>
                <label className='ms-2' htmlFor='year1Checkbox'>
                  1年
                </label>
                <br></br>
                <input
                  ...
                  onChange={handleseniorityChange}
                ></input>
                <label className='ms-2' htmlFor='year2Checkbox'>
                  2年
                </label>
                <br></br>
                <input
                  ...
                  onChange={handleseniorityChange}
                ></input>
                <label className='ms-2' htmlFor='year3Checkbox'>
                  3年
                </label>
                <br></br>
                <input
                  ...
                  onChange={handleseniorityChange}
                ></input>
                <label className='ms-2' htmlFor='year4Checkbox'>
                  4年
                </label>
                <br></br>
                <input
                  ...
                  onChange={handleseniorityChange}
                ></input>
                <label className='ms-2' htmlFor='year5Checkbox'>
                  5年以上
                </label>
                <br></br>
              </div>
            ...
            >
              ...
              >
                ...
                ></input>
                <label htmlFor='taipeiCheckbox'>臺北市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='newtaipei'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='newtaipeiCheckbox'>新北市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='taoyuan'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='taoyuanCheckbox'>桃園市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='keelung'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='keelungCheckbox'>基隆市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='hsinchu'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='hsinchuCheckbox'>新竹市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='hsinchucounty'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='hsinchucountyCheckbox'>新竹縣</label>
                <br></br>
                ...
                <input
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='taichungCheckbox'>臺中市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='miaoli'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='miaoliCheckbox'>苗栗縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='changhua'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='changhuaCheckbox'>彰化縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='nantou'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='nantouCheckbox'>南投縣</label>
                <br></br>
                ...
                <input
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='yunlinCheckbox'>雲林縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='kaohsiung'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='kaohsiungCheckbox'>高雄市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='tainan'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='tainanCheckbox'>臺南市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='chiayi'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='chiayiCheckbox'>嘉義市</label>
                <br></br>
                <input
                  type='checkbox'
                  name='chiayicounty'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='chiayicountyCheckbox'>嘉義縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='pingtung'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='pingtungCheckbox'>屏東縣</label>
                <br></br>
                ...
                <input
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='yilanCheckbox'>宜蘭縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='hualien'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='hualienCheckbox'>花蓮縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='taitung'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='taitungCheckbox'>臺東縣</label>
                <br></br>
                ...
                <input
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='penghuCheckbox'>澎湖縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='kinmen'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='kinmenCheckbox'>金門縣</label>
                <br></br>
                <input
                  type='checkbox'
                  name='lienchang'
                  ...
                  onChange={handlecountryChange}
                ></input>
                <label htmlFor='lienchangCheckbox'>連江縣</label>
                <br></br>
              </div>
            </div>
          </div>
              ...
              {service.map((item, index) => (
                ...
                >
                  <div className='card'>
                    ...
                    <Link
                      to={`/talent/${item.mid}`}
                      className={`card-body text-decoration-none ${styles.link}`}
                    >
                    ...
                    <div className='card-footer d-flex justify-content-between align-items-center'>
                        ...
                        {isLoggedIn === true && item.fid ? (
                          <>
                            <FaHeart
                              ...
                              onClick={() => {
                                cancelServiceCollection(item.fid);
                              }}
                            />
                          </>
                        ) : (
                          <FaRegHeart
                            className={styles.faregheart}
                            onClick={
                              isLoggedIn
                                ? () => {
                                    addServiceCollection(item.sid);
                                  }
                                : handleShow
                            }
                          />
                      ...
                      <div
                        onClick={
                          isLoggedIn ? () => toggleChat(item.mid) : handleShow
                        }
