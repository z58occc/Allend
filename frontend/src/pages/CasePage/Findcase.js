    ...
    switch (s) {
      case 'd_amount':
        ...
        if (changeorder == false) {
          for (let i = 0; i < posts.length; i++) {
            const x = posts.sort(function (a, b) {
              return a.d_amount - b.d_amount;
            });
            setPosts(x);
          }
          setChangeorder(true);
      ...
      case 'quote_total':
        ...
        if (changeorderQuote == false) {
          for (let i = 0; i < posts.length; i++) {
            const x = posts.sort(function (a, b) {
              return a.quote_total - b.quote_total;
            });
            setPosts(x);
          ...
          for (let i = 0; i < posts.length; i++) {
            const x = posts.sort(function (a, b) {
              return b.quote_total - a.quote_total;
            });
            setPosts(x);
          }
      ...
      <div className='container ' style={{ minHeight: '100vh' }}>
        ...
        <div>
          ...
          >
            <button
              ...
              className={changecolor1 == true ? 'active' : ''}
            >
              全部案件
            </button>
          </Link>
          <button
            ...
            className={changecolor2 == true ? 'active' : ''}
            onClick={() => handlechangeduration('短')}
          >
            短期案件
          </button>
          <button
            ...
            className={changecolor3 == true ? 'active' : ''}
            onClick={() => handlechangeduration('長')}
          >
            長期案件
          </button>
        </div>
        ...
        <div style={{ textAlign: 'end', marginBottom: '0.5rem' }}>
          <button
            ...
            className={changecolor5 == true ? 'active' : ''}
          ...
          <button
            ...
            className={changecolor4 == true ? 'active' : ''}
          ...
          <button
            ...
            className={changecolor6 == true ? 'active' : ''}
            onClick={() => sortData('d_amount')}
          >
            預算金額
            <GoTriangleDown
              style={{ display: changeorder == false ? '' : 'none' }}
            />
            <GoTriangleUp
              style={{ display: changeorder == true ? '' : 'none' }}
            />
          </button>
          <button
            style={{
            ...
            className={changecolor7 == true ? 'active' : ''}
            onClick={() => sortData('quote_total')}
          >
            提案人數
            <GoTriangleDown
              style={{ display: changeorderQuote == false ? '' : 'none' }}
            />
            <GoTriangleUp
              style={{ display: changeorderQuote == true ? '' : 'none' }}
            />
          </button>
        </div>
            ...
            <>
              ...
              >
                <button className='mb-3'>
                  清空篩選條件
                  <GrClearOption color='pink' id='clean' size={30} />
                </button>
              </Link>
              <br />
              <div style={{ display: typeid == null ? 'none' : '' }}>
                類別：<strong>「{typeid}」</strong>
              </div>
              {cityid.length > 0 && (
                <Fragment key={`${cityid}`}>
                  地區：<strong style={{}}>「{cityid}」</strong>
                </Fragment>
              )}
              <br />
              {budgetid.length > 0 && (
                <Fragment key={`${budgetid}`}>
                  金額：<strong style={{}}>「{budgetid}」</strong>
                </Fragment>
              )}
            </>
          ) : null}
        ...
        >
          <IoIosSad size={80} color='#002546' />
          Oops!! 看來目前沒有符合篩選條件的資料喔!
        </div>
        {/* 沒有符合條件的資料 */}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div id={changecolortype == true ? 'active' : ''}>
                          案件類別：{post.type}
                        </div>
                        <div id={changecolorbudge == true ? 'active' : ''}>
                          預算：${post.d_amount}&nbsp;/&nbsp;{post.d_unit}
                        </div>
                        <div id={changecolorcity == true ? 'active' : ''}>
                          地點：{post.country_city}
                        </div>
                        <div id={changecolorduration == true ? 'active' : ''}>
                          {post.d_duration}期
                        </div>
                      </Link>
                    </Col>
                    ...
                    >
                      <div style={{ padding: '.5rem', textAlign: 'center' }}>
                        <div
                          ...
                          id={changecolorupdated_at == true ? 'active' : ''}
                        >
                          {post.updated_at}
                        </div>
                        <div
                          id={changecolorquote_total == true ? 'active' : ''}
                        >
                          {post.quote_total}人報價中
                        </div>
                        <div>刊登時間：</div>
                        <div id={changecolorcreated_at == true ? 'active' : ''}>
                          {post.created_at}
                        </div>
                        <Button
                          style={{ fontSize: '16px' }}
        ...
        <Modal show={show} onHide={close}>
          <Modal.Header closeButton>
            <Modal.Title style={{ fontSize: '32px' }}>報價表單</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form style={{ fontSize: '20px' }}>
              ...
              >
                ...
                <Form.Control as='textarea' rows={3} ref={QuoteMessage} />
              </Form.Group>
            </Form>
          </Modal.Body>
          <Modal.Footer style={{ display: 'flex', justifyContent: 'center' }}>
            <Button
              variant='primary'
              onClick={() => handleClose(posts[key]?.did)}
              style={{
                width: '110px',
                fontSize: '18px',
                whiteSpace: 'nowrap',
        ...
        <Modal
          show={failshow}
          onHide={close}
          style={{ marginTop: '250px', fontSize: '30px', textAlign: 'center' }}
        >
          <Modal.Body>
        ...
        <Modal
          show={successshow}
          onHide={close}
          style={{ marginTop: '250px', fontSize: '50px', textAlign: 'center' }}
        >
          <Modal.Body>
